...
def hello_world():
	...
	model = pickle.load(open('divorce_r_forest', 'rb'))
	print("Model: {}", model)
	ll = ['2', '4', '1', '2', '3', '2', '4', '5', '2', '3', '2', '4', '1', '2', '3', '2', '4', '5', '2', '3']
	ll3 = [ll]
	print("ll3: {}", ll3)
...
def reduce_features(features):
	...
	pca = PCA(n_components=n_components) # Principal Component Analysis technique
	pca.fit(features)
